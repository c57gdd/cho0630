...
const UUID = process.env.UUID || '14d7fb7a-28c0-43e5-a581-1131e6f4b319'; //若需要改UUID，需要在config.json里改为一致
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'pdFgmRoEBpLjFWlTfR';
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'cho0630.clnbhft.cf';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiODMyOTk3ZjhhM2RkOTAyYWU1NTlmMjlhZDExMWYwOTciLCJ0IjoiMWFmZmYzM2MtZGQwOS00NjJhLWI2MGEtMDRhMDZhOWJkYTdkIiwicyI6Ik4yTmxNbUV6WVRrdE5EVTFaQzAwTXpVM0xUa3laamd0T0Raak5EZG1OVEEwWVdJeSJ9';
